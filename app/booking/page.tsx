...
export default function BookingPage() {
  ...
  const subtotal = selectedSlots.length * PRICE_PER_SLOT
      ...
      <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-neutral-300">
            Choose your date, pick available time slots, and review your booking
            total before continuing to checkout.
          </p>
        ...
        <div className="rounded-3xl border border-[#4a3526] bg-[#130f0c]/90 p-6 shadow-xl">
          ...
          <div className="mt-3 flex items-end gap-2">
            ...
            <span className="pb-2 text-neutral-400">CAD / 30 min</span>
          </div>
    ...
    <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_390px]">
      <section className="rounded-[2rem] border border-white/10 bg-[#0b0b0b] p-6 shadow-xl md:p-8">
          ...
          <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Slots will appear after you choose a booking date.
              </p>
            </div>
        ...
        <div className="mt-6 rounded-3xl border border-white/10 bg-[#101010] p-5">
          ...
          <p className="mt-1 text-sm text-neutral-400">
            Select one or more 30-minute blocks. Booked slots are disabled.
          </p>
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs opacity-75">
                      {isBooked
                        ...
                        : isSelected
                        ? "This slot is added to your booking."
                        : "Tap to add this slot."}
                    </p>
                  </button>
                )
              })}
      ...
      <aside className="h-fit rounded-[2rem] border border-[#4a3526] bg-[#130f0c] p-6 shadow-xl md:sticky md:top-6">
        ...
        <div className="mt-6 space-y-4 text-sm">
          <div className="flex justify-between border-b border-white/10 pb-4">
            ...
            <span className="text-right font-medium">{date || "Not selected"}</span>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-white/10 bg-[#080808] p-5">
          <div className="flex justify-between text-sm text-neutral-400">
            <span>Subtotal</span>
            <span>{selectedSlots.length} × $50</span>
          </div>
